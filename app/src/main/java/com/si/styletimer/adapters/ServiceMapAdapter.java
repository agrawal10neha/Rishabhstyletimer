...
import com.si.styletimer.databinding.ServicemapCellBinding;
...
public class ServiceMapAdapter extends RecyclerView.Adapter<ServiceMapAdapter.ViewHolder> {
    ...
    public ServiceMapAdapter(Context mContext, List<Sercvice> mSercviceList) {
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        ...
        final ServicemapCellBinding binding = DataBindingUtil.inflate(inflater, R.layout.servicemap_cell, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private final ServicemapCellBinding binding;

        public ViewHolder(final View view, final ServicemapCellBinding binding) {
            super(view);
